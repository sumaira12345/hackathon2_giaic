            ...
            <div className="flex flex-col lg:col-span-3 lg:max-w-[248px]">
              <h1
                className={cn([
                  ...
                  "text-[28px] lg:text-[32px] mb-6 animate-bounce",
                ])}
              >
                SHOP.CO
              </h1>
              ...
              <div className="flex items-center">
                {socialsData.map((social) => (
                  <Link
                    ...
                    key={social.id}
                    target="_blank"
                    className="bg-black hover:bg-white hover:text-black text-white transition-all mr-3 w-7 h-7 rounded-full border border-black/20 flex items-center justify-center p-1.5 animate-spin"
                  >
                    {social.icon}
                  </Link>
                ))}
